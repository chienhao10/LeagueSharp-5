...
namespace Sharpshooter.Champions
{
    public static class Ashe
    {
        ...
        public static void Load()
        {
            ...
            W.SetSkillshot(0.25f, (float)(57.5f * Math.PI / 180), 1600f, true, SkillshotType.SkillshotCone);
        ...
        static void AntiGapcloser_OnEnemyGapcloser(ActiveGapcloser gapcloser)
        {
            ...
            {
                if (R.CanCast(gapcloser.Sender) && gapcloser.Sender.IsTargetable)
        ...
        static void Interrupter_OnPossibleToInterrupt(Obj_AI_Base unit, InterruptableSpell spell)
        {
            ...
            {
                if (R.CanCast(unit) && unit.IsTargetable)
                    R.Cast(unit);
