...
namespace Sharpshooter.Champions
{
    public static class Jinx
    {
        ...
        public static void Load()
        {
            ...
            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingTarget", "Target", true).SetValue(true));
        ...
        static void Combo()
        {
            ...
            if (SharpShooter.Menu.Item("comboUseR", true).GetValue<Boolean>())
            {
                ...
                if (R.CanCast(Rtarget) && Rpred.Hitchance >= HitChance.VeryHigh)
                {
                    ...
                    var predhealth = HealthPrediction.GetHealthPrediction(Rtarget, (int)(R.Delay + dis / R.Speed) * 1000);
